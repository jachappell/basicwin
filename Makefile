...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.WkuHBu>
...
# operating system:  Linux 2.6.17-2-486 i686 [ELF] (2.6.17)
# libc:	(6.3.6)
# binutils:	(217)
...
.SUFFIXES: .cc
    ...
    CXXDEBUGFLAGS = -g  -fno-strict-aliasing 
CXXDEPENDINCLUDES =
 CXXEXTRA_DEFINES =
CXXEXTRA_INCLUDES =
  ...
  EXTRA_LIBRARIES =
   ...
   PARALLELMFLAGS =
    ...
    INSTKMEMFLAGS = -m 4711
      ...
      CDEBUGFLAGS = -g -fno-strict-aliasing
        CCOPTIONS =
...
basicwin: $(OBJS1)
	$(RM) $@
	$(CXXLINK) -o $@ $(LDOPTIONS) $(OBJS1) $(LOCAL_LIBRARIES) $(LDLIBS)  $(EXTRA_LOAD_FLAGS)
